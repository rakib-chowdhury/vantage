...
@section('page_header','Treatment List')
...
@section('page_content')
    <div class="col-sm-12">
        <div class="white-box">
            @if(sizeof($treatment_info)<=($condition[0]->treatment-1))
                <div>
                    <a href="{{url('treatment/add')}}" class="btn btn-success btn-rounded">Add Treatment</a>
                    <hr>
                </div>
            @endif
            <div class="table-responsive">
                <table id="myTable1" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; ">
                            <a href="{{url('treatment/edit')}}/{{$u->id}}">
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                            </a>&nbsp;
                            <a href="{{url('treatment/delete')}}/{{$u->id}}">
