<?php $__env->startSection('page_title','Treatment'); ?>
<?php $__env->startSection('page_header','Treatment List'); ?>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            <?php if(sizeof($treatment_info)<=($condition[0]->treatment-1)): ?>
                <div>
                    <a href="<?php echo e(url('treatment/add')); ?>" class="btn btn-success btn-rounded">Add Treatment</a>
                    <hr>
                </div>
            <?php endif; ?>
            <div class="table-responsive">
                <table id="myTable1" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tbody>
                    <?php foreach ($treatment_info as $key => $u) { ?>
                    <tr>
                        ...
                        <td style="text-align: center; ">
                            <a href="<?php echo e(url('treatment/edit')); ?>/<?php echo e($u->id); ?>">
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                            </a>&nbsp;
                            <a href="<?php echo e(url('treatment/delete')); ?>/<?php echo e($u->id); ?>">
