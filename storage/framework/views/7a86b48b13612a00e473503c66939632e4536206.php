...
<section id="wrapper" class="login-register">
  <div class="login-box">
    <div class="white-box">
      ...
      <?php endif; ?>
      <?php if(Session::has('message_logout')): ?>
        <div class="alert alert-success">
          <?php echo e(Session::get('message_logout')); ?>
      ...
      <?php endif; ?>
        ...
        <?php if ($value>0) {?>
      <div align="center">
        <img style="height:100px;width:100px;" src="public/images/<?php echo e($all_info[0]->logo); ?>"  alt='logo'>
      </div>
      <div align="center">
        <h4> <?php echo e($all_info[0]->name); ?></h4>
      </div>

        <?php }?>
        

      <form class="form-horizontal form-material" id="loginform"  onsubmit="return get_login()" action="<?php echo e(url('login/login_check')); ?>" method="post">
