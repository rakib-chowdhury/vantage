...
@section('page_header','Service List')
...
@section('page_content')
    <div class="col-sm-12">
        <div class="white-box">
            @if(sizeof($service_info)<=($condition[0]->service-1))
                <div>
                    <a href="{{url('service/add')}}" class="btn btn-success btn-rounded">Add Service</a>
                    <hr>
                </div>
            @endif
            <div class="table-responsive">
                <table id="myTable1" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; ">
                            <a href="{{url('service/edit')}}/{{$u->id}}">
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                            </a>&nbsp;
                            <a href="{{url('service/delete')}}/{{$u->id}}">
