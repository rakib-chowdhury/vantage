...
<?php $__env->startSection('page_header','Edit Treatment'); ?>
<?php $__env->startSection('page_breadcrumb'); ?>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(url('home/dashboard')); ?>">Dashboard</a></li>
        <li><a href="<?php echo e(url('treatment/show')); ?>">Treatment</a></li>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            <form onsubmit=" return chkTreatment()" data-toggle="validator" enctype="multipart/form-data"
                  id="info" action="<?php echo e(url('treatment/edit_post')); ?>" method="post">
                <?php echo e(csrf_field()); ?>

                <input type="hidden" name="id" value="<?php echo e($treatments[0]->id); ?>">
                <div class="form-group">
                    <label for="name" class="control-label">Name</label>
                    <input onblur="check_text_field('name','name_err')"
                           type="text" required class="form-control"
                           name="name" id="name" placeholder="Package Name"
                           value="<?php echo e($treatments[0]->name); ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea onkeyup="countLetter()" name="shortNote" id="shortNote" rows="4"
                              class="form-control"><?php echo e($treatments[0]->subject); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote" name="description"
                              id="description"><?php echo e($treatments[0]->details); ?></textarea>
