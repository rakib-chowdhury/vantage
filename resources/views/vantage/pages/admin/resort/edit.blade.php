...
@section('page_title','Edit Treatment')
@section('page_header','Edit Treatment')
@section('page_breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{url('home/dashboard')}}">Dashboard</a></li>
        <li><a href="{{url('treatment/show')}}">Treatment</a></li>
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <form onsubmit=" return chkTreatment()" data-toggle="validator" enctype="multipart/form-data"
                  id="info" action="{{url('treatment/edit_post')}}" method="post">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{$treatments[0]->id}}">
                ...
                <div class="form-group">
                    ...
                    <textarea onkeyup="countLetter()" name="shortNote" id="shortNote" rows="4"
                              class="form-control">{{$treatments[0]->subject}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote" name="description"
                              id="description">{{$treatments[0]->details}}</textarea>
