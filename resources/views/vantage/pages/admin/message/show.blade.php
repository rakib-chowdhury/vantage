...
@section('page_header','Message List')
                ...
                <table class="table table-responsive table-bordered">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('new_message/new')}}" class="pull-right btn btn-info btn-rounded" style="text-align: right;padding-right: 10px;"><span>New Message</span></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
