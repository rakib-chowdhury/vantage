    ...
    <div class="white-box">
        <div>
            ...
            <div id="addCat" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <!-- Modal content-->
                    <form onsubmit="return formValidate()" action="<?php echo e(url('resort/add_cat')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    if ($resort_category) {
                        foreach ($resort_category as $row) {
                            ...
                            <tr>
                                ...
                                <!--<td style="text-align: center;">
                                    <img style="width: 120px;" src="<?php echo e(url('public/images/resort_category/'.$row->cat_image)); ?>" alt="">
        ...
        ?>
                                ...
                                <td style="text-align: center; ">
                                    ...
                                    <a href="<?php echo e(url('resort/delete_resort_cat')); ?>/<?php echo e($row->id); ?>">
