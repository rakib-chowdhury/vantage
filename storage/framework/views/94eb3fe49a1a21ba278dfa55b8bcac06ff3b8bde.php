...
<?php $__env->startSection('page_header','Package List'); ?>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            <?php if(sizeof($package_info)<=($condition[0]->package-1)): ?>
                <div>
                    <a href="<?php echo e(url('package/add')); ?>" class="btn btn-success btn-rounded">Add Package</a>
                    <hr>
                </div>
            <?php endif; ?>
            <div class="table-responsive">
                <table id="myTable1" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; ">
                            <a href="<?php echo e(url('package/edit')); ?>/<?php echo e($u->id); ?>">
