...
<?php $__env->startSection('page_header','Team List'); ?>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            <?php if(sizeof($team_info)<=($condition[0]->service-1)): ?>
                <div>
                    <a href="<?php echo e(url('team/add')); ?>" class="btn btn-success btn-rounded">Add Team Member</a>
                    <hr>
                </div>
            <?php endif; ?>
                ...
                <table id="myTable1" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; width: 10%">
                            ...
                            <?php else: ?>
                                <img style=" width: 60px; height:60px; border-radius: 50%" src="<?php echo e(url('public/images/team/'.$u->image)); ?>" alt="">
                            <?php endif; ?>
                        ...
                        <td style="text-align: center; ">
                            <a href="<?php echo e(url('team/edit')); ?>/<?php echo e($u->id); ?>">
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                            </a>&nbsp;
                            <a href="<?php echo e(url('team/delete')); ?>/<?php echo e($u->id); ?>">
