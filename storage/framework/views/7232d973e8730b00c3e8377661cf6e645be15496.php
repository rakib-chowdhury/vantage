...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <footer class="footer text-center"><?php echo e($company[0]['footerText']); ?>&nbsp;<a style="color:black; font-weight: 400" target="_blank" href="<?php echo e($company[0]['footerLindAddress']); ?>"><?php echo e($company[0]['footerLink']); ?></a></footer>
    </div>
</div>
