            ...
            <div>
                ...
                <div id="addCat" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <form onsubmit="return chkIMG3()" action="<?php echo e(url('gallery/add_cat')); ?>" method="post">
                ...
                <div id="addSubCat" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <form onsubmit="return chkIMG4()" action="<?php echo e(url('gallery/add_sub_cat')); ?>" method="post">
                            <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <span id="sub_cat_id_err" style="color: red; ">
                                                <?php if($errors->has('sub_cat_id')): ?><?php echo e('Required'); ?><?php endif; ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="row">
