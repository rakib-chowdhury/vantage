<?php $__env->startSection('page_title'); ?>
    <?php echo e($company[0]->name); ?> | Treatment
    ...
    $serviceCLASS=array('cryolipolysis-service','far-service','foot-service','microvibrations-service','alkaline-service');
     ?>
    <?php $__currentLoopData = $treatment_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2=>$service): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <section id="treatment_<?php echo e($key2); ?>" class="treatments_<?php echo e($key2); ?>  content-section">
            <div class="container">
                <div class="row">
                    ...
                    <div id="modal_<?php echo e($key2); ?>" class="modal fade treatments_0" tabindex="-1" role="dialog"
