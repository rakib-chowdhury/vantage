...
<?php $__env->startSection('page_header','Add Treatment'); ?>
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <form onsubmit=" return chkTreatment()" data-toggle="validator" enctype="multipart/form-data"
                  id="info" action="<?php echo e(url('treatment/add_post')); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input onblur="check_text_field('name','name_err')"
                           ...
                           name="name" id="name" placeholder="Treatment Name"
