...
@section('page_header','Edit Team Member')
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <form onsubmit=" return chkTeam()" data-toggle="validator" enctype="multipart/form-data"
                  id="info" action="{{url('team/edit_post')}}" method="post">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{$teams[0]->id}}">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input onclick="chkIMG()" type="file" data-show-remove="false"
                               ...
                               data-default-file="{{url('public/images/team/'.$teams[0]->image)}}">
                ...
                <div class="form-group">
                    ...
                    <textarea required onkeyup="countLetter()" name="shortNote" id="shortNote" rows="3"
                              class="form-control">{{$teams[0]->subject}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote" name="description" id="description">{{$teams[0]->details}}</textarea>
