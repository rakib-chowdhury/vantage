...
//            alert(div_id);
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("get-resort-pics")); ?>',
                data: {
                    catId: cat_id
...
//            console.log(subCat);
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("get_resort_pics")); ?>',
                data: {
                    catId: cat
//                    subCat : subCat
                }, success: function (result) {
...
//            alert(div_id);
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("get-vip-resort-pics")); ?>',
                data: {
                    catId: cat_id
                }, success: function (result) {
//                    alert(result)
...
//            console.log(subCat);
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("get_vip_resort_pics")); ?>',
                data: {
                    catId: cat
                }, success: function (result) {
                    var itms = [];
...
//            alert(div_id);
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("get-other-resort-pics")); ?>',
                data: {
                    catId: cat_id
                }, success: function (result) {
//                    alert(result)
...
//            console.log(subCat);
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("get_other_resort_pics")); ?>',
                data: {
                    catId: cat
                }, success: function (result) {
                    var itms = [];
