                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form onsubmit="return checkPass()"
                                                          action="{{url('user/update_password')}}" method="post">
                                                        {{csrf_field()}}
                                                        <div class="row">
                ...
                <div class=" panel col-md-8 " style="border-color: black; margin-left: 2px;">
                    <table class="table-responsive table">
                        <tr>
                            <td class="pull-right" style="padding-right: 15px;">
                                ...
                                <div id="newMSG" class="modal fade about-us-modal" data-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <form onsubmit="return chkMSG()" action="{{url('message/post')}}" method="post"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="form-group" style="text-align: center">
                                                    ...
                                                    <a href="{{url('myAccount/show')}}" class="btn btn-danger">
                                                        Close
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <td class="pull-right">
                                <a href="{{url('myAccount/show')}}" data-placement="top" title="Refresh">
                            ...
                            <table class="table-responsive table">
                                ...
                                <tr>
                                    <td style="width: 6%">
                                        ...
                                        @else
                                            <img style="width: 30px; height: 30px; border-radius: 50% "
                                                 src="{{url('public/images/'.$company[0]->logo)}}"
                                                 alt="">
                                        @endif
                                    </td>
                                    <td style="width: 20%">
                                    ...
                                    <td style="width: 18%">{{$msg->created_at}}</td>

                                    <div id="sms_{{$msg->id}}" class="modal fade about-us-modal" tabindex="-1"
                                         role="dialog"
                                         aria-labelledby="myLargeModalLabel">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
